...
final class TaskListViewController: UITableViewController {
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        if !taskList.tasks.isEmpty && taskList.tasks.filter("isComplete = false").isEmpty {
    ...
    @IBAction func sortingList(_ sender: UISegmentedControl) {
        ...
        case 0:
            let sortedTaskLists = taskLists.sorted(byKeyPath: "date", ascending: true)
            taskLists = sortedTaskLists
        default:
            let sortedTaskLists = taskLists.sorted(byKeyPath: "title", ascending: true)
            taskLists = sortedTaskLists
        }
    }
